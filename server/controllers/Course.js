...
// here we are creating new Course handler function
exports.createCourse = async (req, res) => {
    try {
        ...
        // check given category/tag is valid or not
        ...
        // create new entry in the database for the new course
        ...
        // update the Category schema to include this new course
        ...
        console.log("updated category details: ", categoryDetails2);
        ...
        res.status(500).json({
            success: false,
            message: "Internal Server Error in creating new course",
            error: error.message,
        });
    }
}
